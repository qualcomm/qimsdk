...
LABELS = load_labels(f"{os.environ['HOME']}/Downloads/qimsdk_samples/labels/dv3-argmax-labels.json")
...
def create_and_execute_pipeline() -> None:
    ...
    inferencing = (
        ...
        .set("model", f"{os.environ['HOME']}/Downloads/qimsdk_samples/models/dv3_argmax_int32.tflite")
    )

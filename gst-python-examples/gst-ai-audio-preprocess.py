...
DESCRIPTION = """
This application sets up a GStreamer pipeline for audio preprocessing and tensor extraction.
It captures audio input, converts frames into tensors using qtimlaconverter, and outputs the
...
PIPELINE = (
    ...
    # Set caps for tensor information
    'neural-network/tensors,type=FLOAT32,dimensions=<<1,1,96,64>> ! queue ! '

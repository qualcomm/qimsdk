...
void create_and_execute_pipeline() {
  ...
  inferencing.set("model", home_path + "/Downloads/qimsdk_samples/models/posenet_mobilenet_v1_075_481_641_quant.tflite");
  ...
  static const std::vector<LabelEntry> labels =
      load_labels(home_path + "/Downloads/qimsdk_samples/labels/posenet.json");

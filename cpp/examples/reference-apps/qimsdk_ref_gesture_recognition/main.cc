...
void create_and_execute_pipeline() {
  ...
  stage_01_inferencing.set("model", home_path + "/Downloads/qimsdk_samples/models/palm_detection_full.tflite");
  ...
  stage_01_postprocessing.set("labels", home_path + "/Downloads/qimsdk_samples/labels/palmd_labels.json");
  stage_01_postprocessing.set("settings", home_path + "/Downloads/qimsdk_samples/labels/palmd_settings.json");
  ...
  stage_02_inferencing.set("model", home_path + "/Downloads/qimsdk_samples/models/hand_landmark_full.tflite");
  ...
  stage_02_1_postprocessing.set("labels", home_path + "/Downloads/qimsdk_samples/labels/hlandmarks.json");
  stage_02_1_postprocessing.set("settings", home_path + "/Downloads/qimsdk_samples/labels/hlandmark_settings.json");
  ...
  stage_03_1_inferencing.set("model", home_path + "/Downloads/qimsdk_samples/models/gesture_embedder.tflite");

  // Executes the ML model and attaches tensor outputs to each frame.
  Element stage_03_2_inferencing("qtimltflite", "stage_03_2_inferencing");
  stage_03_2_inferencing.set("delegate", "gpu");
  stage_03_2_inferencing.set("model", home_path + "/Downloads/qimsdk_samples/models/canned_gesture_classifier.tflite");

  // Decodes model output tensors into metadata for downstream overlay.
  Element stage_03_postprocessing("qtimlpostprocess", "stage_03_postprocessing");
  stage_03_postprocessing.set("module", "mobilenet");
  stage_03_postprocessing.set("labels", home_path + "/Downloads/qimsdk_samples/labels/gesture_rec.json");

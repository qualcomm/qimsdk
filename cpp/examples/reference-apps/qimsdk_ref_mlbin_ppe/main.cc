...
void create_and_execute_pipeline() {
  ...
  src.set("location", home_path + "/Downloads/qimsdk_samples/media/ppe_sample.mp4");
  ...
  mlbin1.set("inference-model", home_path + "/Downloads/qimsdk_samples/models/foot_track_net-person-foot-detection-w8a8.tflite");
  mlbin1.set("postprocess-module", "qpd");
  mlbin1.set("postprocess-labels", home_path + "/Downloads/qimsdk_samples/labels/foot_track_net.json");
  mlbin1.set("postprocess-settings", home_path + "/Downloads/qimsdk_samples/labels/foot_track_net_settings.json");
  ...
  mlbin2.set("inference-model", home_path + "/Downloads/qimsdk_samples/models/gear_guard_net-ppe-detection-w8a8.tflite");
  mlbin2.set("postprocess-module", "yolov8");
  mlbin2.set("postprocess-labels", home_path + "/Downloads/qimsdk_samples/labels/gear_guard_net.json");
